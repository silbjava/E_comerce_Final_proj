export function Cards() {
    return (
        <>
            ...
            <section className=" hidden sm:flex flex-col ml-[92px] w-auto h-auto pb-[7vh]">
                ...
                <div id="Card produto" className="flex-col w-[176px] h-[257px] shadow-card">
                        ...
                        <div className=" pl-3">
                            ...
                            <button className="w-[75px] h-6 mt-2.5 flex rounded bg-blue-900 text-white font-inter font-medium text-px12 leading-14.5 items-center justify-center">Comprar</button>
                        </div>
                    </div>
                    <div id="Card produto" className="flex-col w-[176px] h-[257px] shadow-card">
                        <img className="w-[176px] h-[134px]  rounded" src="src\assets\NiqueAirSurf.png" alt="Card do tênis Niquel Air surf" />
            ...
            <section className="sl:hidden flex-col w-screen pt-[26px] px-3 pb-[10vw]">
                ...
                <div id="Card produto" className="flex-col w-[144px] pb-3 shadow-card">
                        <img className="w-36 h-24  rounded" src="src\assets\NiqueAirSurf.png" alt="Card do tênis Niquel Air surf" />
                        <div className=" pl-3 mt-[9px] flex flex-col gap-[3px]">
                            <p className=" text-blue-900 font-inter font-bold text-px18 leading-21.7">Nique Air Surf</p>
                            <p className=" font-inter font-medium text-px12 leading-14.5 text-[#f0d3d3]">Tênis</p>
                            <p className=" text-orange-500 font-inter font-semibold text-px16 leading-19.36">R{'$'} 200,00</p>
                            <button className="w-[75px] h-5 mt-1 flex rounded bg-blue-900 text-white font-inter font-medium text-px12 leading-14.5 items-center justify-center">Comprar</button>
                        </div>
                    </div>
                    <div id="Card produto" className="flex-col w-[144px] pb-3 shadow-card">
                        <img className="w-36 h-24  rounded" src="src\assets\NiqueAirSurf.png" alt="Card do tênis Niquel Air surf" />
